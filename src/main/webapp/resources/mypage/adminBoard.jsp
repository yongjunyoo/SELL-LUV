...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/admin/css/tailwind.output.css" />
    <script
          ...
          <ul>
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">카드 관리</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 "
                href="/adminBoard.admin"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
                ...
                <span class="ml-4">자유게시판 관리</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 "
                href="/adminMember.admin"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
