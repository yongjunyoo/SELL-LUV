    ...
    <div class="row justify-content-center">
        <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                <h2 id="heading" style="padding-top:50px;">인플루언서 회원 정보 수정</h2>
                <p>모든 칸은 작성되어야 합니다.</p>
                <form id="msform" action="/IFmodify.mem" method="post" enctype="multipart/form-data">
                    <!-- progressbar -->
                    <ul id="progressbar">
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <label class="fieldlabels">SNS 링크: </label> <input type="text" id="sns" name="sns" placeholder="SNS Link(선택사항)" value="${dto.sns }"/>
