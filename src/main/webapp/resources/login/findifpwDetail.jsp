      ...
      <div class="wrapper">
         ...
         <div class="form-container">
            <div class="slide-controls">
               <label for="login" class="slide login" style="cursor:default;background:white;color:black;">기업</label>
               <label for="signup" class="slide signup" style="cursor:default;background:rgba(255, 111, 97);color:white">개인</label>
