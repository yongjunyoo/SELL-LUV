                ...
                <div class="col-lg-8 m-15px-tb">
                    <article class="article">
                        <div class="article-img">
                            <img src="img/오일남.jpeg" title="" alt="">
                        </div>
                        <div class="article-title">
                            <!--소개글-->
                            <h2>여기는 소개글입니다..? 아무거나 쓰세요</h2>
                            <div class="media">
                                <div class="avatar">
                    ...
                    <div class="contact-form article-comment">
                        ...
                        <form id="contact-form" action="/write.review" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea name="message" id="message" placeholder="글 남기기 *" rows="4" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="send">
                                        <button class="px-btn theme"><span>작성완료</span> <i class="arrow"></i></button>
                                    </div>
                                </div>
                            </div>
                        </form>
